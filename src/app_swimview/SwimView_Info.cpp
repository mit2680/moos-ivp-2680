...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  swimview is a utility for rendering one or more swim files.   ");
}
...
{
  cout << "===================================================" << endl;
  cout << "Usage: swimview [OPTIONS] [FILES]                  " << endl;
  cout << "===================================================" << endl;
  cout << "                                                   " << endl;
  showSynopsis();
  cout << "                                                   " << endl;
