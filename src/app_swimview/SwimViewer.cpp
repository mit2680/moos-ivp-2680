...
SwimViewer::SwimViewer(int x, int y, int w, int h, const char *l)
...
int SwimViewer::handle(int event)
{
  int vx, vy;
  switch(event) {
  case FL_PUSH:
...
void SwimViewer::drawGeoObjects()
{
...
void SwimViewer::toggleDrawMarkerLabels()
{
...
void SwimViewer::handle_left_mouse(int vx, int vy)
{
#if 0
...
void SwimViewer::handle_right_mouse(int vx, int vy)
{
#if 0
...
bool SwimViewer::setParam(string param, string value)
{
...
bool SwimViewer::setParam(string param, double pval)
{
...
void SwimViewer::reApplySnapToCurrent()
{
#if 0
...
void SwimViewer::drawSwimSet(SwimmerSet swimset)
{
...
void SwimViewer::eraseSwimSet(SwimmerSet swimset)
{
  vector<Swimmer> swimmers = swimset.getSwimmers();
...
void SwimViewer::incCurrSwimSet()
{
...
void SwimViewer::decCurrSwimSet()
{
...
bool SwimViewer::readSwimFile(string filestr)
{
  SwimmerSet swimset;
...
bool SwimViewer::readGeomFile(string filestr)
{
...
string SwimViewer::getCurrSwimFile() const
{
  if(m_curr_swimset >= m_swimsets.size())
    return("");
...
unsigned int SwimViewer::getCurrReg() const
{
  if(m_curr_swimset >= m_swimsets.size())
    return(0);
...
unsigned int SwimViewer::getCurrUnreg() const
{
  if(m_curr_swimset >= m_swimsets.size())
    return(0);
...
double SwimViewer::getCurrMinSep() const
{
  if(m_curr_swimset >= m_swimsets.size())
    return(0);
...
string SwimViewer::getColorByIndex() const
{
  if(m_curr_swimset == 0)
    return("lime");
